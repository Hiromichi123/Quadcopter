/** @file
 *  @brief MAVLink comm protocol generated from smart_car.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_SMART_CAR_H
#define MAVLINK_SMART_CAR_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_SMART_CAR.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif

#define MAVLINK_SMART_CAR_XML_HASH 6800810383236017965
...
typedef enum SMART_CAR_STATE
{
   ...
   SMART_CAR_STATE_ENUM_END=5, /*  | */
} SMART_CAR_STATE;
#endif

/** @brief  */
#ifndef HAVE_ENUM_SMART_CAR_CONTROL_FLAGS
#define HAVE_ENUM_SMART_CAR_CONTROL_FLAGS
typedef enum SMART_CAR_CONTROL_FLAGS
{
   ...
   SMART_CAR_CONTROL_FLAGS_ENUM_END=9, /*  | */
} SMART_CAR_CONTROL_FLAGS;
#endif

/** @brief  */
#ifndef HAVE_ENUM_SMART_CAR_FAULT_FLAGS
#define HAVE_ENUM_SMART_CAR_FAULT_FLAGS
typedef enum SMART_CAR_FAULT_FLAGS
{
   ...
   SMART_CAR_FAULT_FLAGS_ENUM_END=33, /*  | */
} SMART_CAR_FAULT_FLAGS;
#endif

/** @brief  */
#ifndef HAVE_ENUM_SMART_CAR_COMMAND
#define HAVE_ENUM_SMART_CAR_COMMAND
typedef enum SMART_CAR_COMMAND
{
